...
from utils.trainer import AETrain, SADTrain
...
def main(network_name, CALLBACK, feature):
    ...
    #    model = AETrain(net_name, result_path, feature)
    #    model = init_weight(model, net_name, feature)
    ...
    model = SADTrain(model, net_name, CALLBACK)
...
if __name__ == '__main__':
    ...
    model_name = ['linear_1','linear_1', 
                  'conv_1', 'conv_1', 
                  'linear_1', 'linear_1',
                  'linear_1', 'linear_1'
                  ]
    #model_name = ['conv_1', 'conv_1']
